  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {language === "ltr"
            ? "Payzah Privacy Policy"
            : "سياسة الخصوصية لبايزاه"}
        </Box>
        {language === "ltr" ? (
          <div class="mailbox-read-message">
            <p>
              Privacy Policy for Payzah Services Last Updated: [18th of December
              2024]
            </p>
            ...
            <p>
              ...
              safeguard your information when you use our services, which
            ...
            <p>
              ...
              number, and payment details. - Transactional Information: Details
              of transactions carried out through our services. - Technical
              Information: IP address, browser type, device information, and
            ...
            <p>
              ...
              information. - Ensure security and prevent fraudulent activities.
            </p>
            ...
            <p>
              ...
              by public authorities. - To protect the rights, property, or
              safety of Payzah Services, our users, or the public.
            </p>
            ...
            <p>
              ...
              of your personal information. Your data is stored using SSL
              encryption and other advanced technologies. However, no method of
            ...
            <p>
              ...
              experience on our platform. Cookies help us understand how you use
              our services and improve them accordingly. You can control the use
            ...
            <p>
              ...
              services after such changes indicates your acceptance of the new
              policy.
            </p>
            ...
            <p>
              - Email: info@payzah.com - Address: Kuwait City, Dar Alawadi Mall,
              Floor 1, Payzah Office Payzah Payments Systems W.L.L.C +965 565
              00733
            </p>
          </div>
        ) : (
          <div class="mailbox-read-message" style={{ fontSize: "18px" }}>
            ...
            <p>
              <span>
                <span>
                  <span dir="RTL">
                    مرحبًا بك في خدمات بيزة للمدفوعات، الحل المالي الشامل المقدم
                    من شركة بيزة لأعمال نظم الدفع &nbsp;والتسويات الإلكترونية.
                    نحن ملتزمون بحماية خصوصيتك وضمان أمان معلوماتك الشخصية. تشرح
                    سياسة الخصوصية هذه كيف نقوم بجمع واستخدام وحماية معلوماتك
                    عندما تستخدم خدماتنا، والتي تشمل روابط الدفع، روابط الويب،
                    المتاجر الإلكترونية، الحجز، وبوابة الدفع
                  </span>
                  .
                </span>
              </span>
            ...
            <p>
              <span>
                <span>
                  ...
                  رقم هاتفك، وتفاصيل الدفع. - **المعلومات المعاملاتية**: تفاصيل
                  المعاملات التي تمت عبر خدماتنا. - **المعلومات التقنية**:
                  عنوان&nbsp;IP، نوع المتصفح، معلومات الجهاز، وبيانات تقنية
                  أخرى.
                </span>
              </span>
            </p>
            ...
            <p>
              <span>
                <span>
                  <span dir="RTL">
                    نحن لا نبيع أو نؤجر معلوماتك الشخصية لأطراف ثالثة. ومع ذلك،
            ...
            <p>
              <span>
                <span>
                  ...
                  &nbsp;SSL&nbsp;وتكنولوجيا متقدمة أخرى. ومع ذلك، لا توجد طريقة
                  نقل عبر الإنترنت أو تخزين إلكتروني مضمونة تمامًا، ولا يمكننا
                  ضمان الأمان المطلق.
                </span>
              </span>
            </p>
              ...
              <span>
                <span>
                  <span dir="RTL">
                    ...
                    وتحسينها وفقًا لذلك. يمكنك التحكم في استخدام الكوكيز من خلال
                    إعدادات متصفحك
                  </span>
                  .
                </span>
